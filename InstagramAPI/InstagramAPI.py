...
class InstagramAPI:
    ...
    DEVICE_SETTINTS = {'manufacturer': 'Samsung',
                       ...
                       'android_version': 24,
                       'android_release': '7.0'}
    USER_AGENT = 'Instagram 76.0.0.15.395 Android ({android_version}/{android_release}; 640dpi; 1440x2560; {manufacturer}; {model}; armani; qcom; en_US)'.format(**DEVICE_SETTINTS)
